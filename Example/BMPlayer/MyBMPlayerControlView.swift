...
@objc public protocol MyBMPlayerControlViewDelegate: class {
    /**
     ...
     */
    func controlView(controlView: MyBMPlayerControlView, didChooseDefition index: Int)
     ...
     */
    func controlView(controlView: MyBMPlayerControlView, didPressButton button: UIButton)
     ...
     */
    func controlView(controlView: MyBMPlayerControlView, slider: UISlider, onSliderEvent event: UIControlEvents)
     ...
     */
    @objc optional func controlView(controlView: MyBMPlayerControlView, didChangeVideoPlaybackRate rate: Float)
}

open class MyBMPlayerControlView: UIView {
    
    open weak var delegate: MyBMPlayerControlViewDelegate?
...
//        }
    ...
    func setupUIComponents() {
        ...
        backButton.tag = MyBMPlayerControlView.ButtonType.back.rawValue
        ...
        playButton.tag = MyBMPlayerControlView.ButtonType.play.rawValue
        ...
        fullscreenButton.tag = MyBMPlayerControlView.ButtonType.fullscreen.rawValue
